...
//                                  $stock = $oIfx->f('prbo_dis_prod');
                                    ...
                                    $onclik = "datos('$codigo','$nom_bodega','$precio','$disponible','$nombre','$cuenta','$cuenta_iva','$lote','$serie','$cod_tpro','$prod_stock_neg','$prbo_cco_prbo','$costo','$iva');";
...
<script>
    ...
    function datos(codigo, bodega, precio, stock, nombre, cuenta, cuenta_iva, lote, serie, tipo_prod, stock_neg, ccosn,costo,iva) {
        ...
        parent.document.form1.costo.value = costo;
        parent.document.form1.iva.value = iva;
